package com.jialin.workattendance.dao.impl;
 ...
 * @Description :考勤记录管理
 */
public class WorkattenceDaoImpHibernate extends HibernateBasicDao<WorkattenceEntity,String> implements IWorkattenceDao {
