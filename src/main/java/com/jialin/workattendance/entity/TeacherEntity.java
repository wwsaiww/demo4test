package com.jialin.workattendance.entity;

import com.jialin.basic.entity.AbstractEntity;
...
/**
 * Created by JiaLin on 2014/5/27.
 */
@Entity
@Table(name = "teacher", schema = "", catalog = "workattendance")
